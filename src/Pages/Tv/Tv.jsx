...
export default class Tv extends Component {
    ...
    getTvSerries(page) {
        axios
            .get(
                `https://api.themoviedb.org/3/trending/tv/day?api_key=0c46ad1eb5954840ed97f5e537764be8&page=${page}`
            )
            .then((res) => {
                            ...
                            {React.Children.toArray(
                                ...
                                this.state.tv.map((value) => {
                                    return value.poster_path !== null ? (
                                        <div
                                            className="item col-xl-3 col-lg-4 col-md-6 col-sm-6 my-2 card card-body mb-3"
                                            onClick={() => this.goToTvAbout(value)}
                                        >
                                            <div className="text-center position-relative">
                                                ...
                                                <span
                                                    className={`${value.poster_path !== null ? (value.vote_average >= 7 ? "vote vote1" : "vote vote2") : ""}`}
                                                >
